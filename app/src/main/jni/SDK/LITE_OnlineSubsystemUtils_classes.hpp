...
// 0x0040 (0x295F0 - 0x295B0)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x295B0(0x0040) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0540(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0540(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0541(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0544(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0548(0x000C) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0554(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x0558(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x055C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x0560(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0564(0x0050) MISSED OFFSET
	float                                              RecreateSocketCooldownTime;                               // 0x05B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RecreateSocketMaxTryCount;                                // 0x05B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bResolveRemoteHostOnRecreateSocket;                       // 0x05BC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenReceiveEmptyPackets;                  // 0x05BD(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenConReceiveEmptyPackets;               // 0x05BE(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x05BF(0x0001) MISSED OFFSET
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x02CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x02D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x02D4(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x02E8(0x0004) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x02EC(0x0004) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x02F0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x27];                                      // 0x02F1(0x0027) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x02E8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x02EC(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x78];                                      // 0x02F8(0x0078) MISSED OFFSET
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x02C8(0x000C) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x02D4(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x02D8(0x000C) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x14];                                      // 0x0318(0x0014) MISSED OFFSET
	struct FString                                     DestSessionId;                                            // 0x032C(0x000C) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0338(0x001C)
	EClientRequestType                                 RequestType;                                              // 0x0354(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0355(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0356(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x29];                                      // 0x0357(0x0029) MISSED OFFSET
...
public:
	...
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0310(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0311(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0314(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0318(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
