...
{
public:
	class ULuaStateWrapper*                            OwningLuaStateWrapper;                                    // 0x02C8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UObject*                                     OwningObject;                                             // 0x02CC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UScriptContextComponent*                     ScriptContextComponent;                                   // 0x02D0(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FString                                     SourceCode;                                               // 0x00B8(0x000C) (ZeroConstructor)
...
{
public:
	struct FString                                     TestString;                                               // 0x02C8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              TestValue;                                                // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               TestBool;                                                 // 0x02D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
