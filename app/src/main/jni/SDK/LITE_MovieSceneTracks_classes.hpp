...
public:
	...
	EAttachmentRule                                    AttachmentLocationRule;                                   // 0x00B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentRotationRule;                                   // 0x00B9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentScaleRule;                                      // 0x00BA(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentLocationRule;                                   // 0x00BB(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentRotationRule;                                   // 0x00BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentScaleRule;                                      // 0x00BD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class UMovieSceneSection*>                  ConstraintSections;                                       // 0x0050(0x000C) (ExportObject, ZeroConstructor)
...
public:
	...
	EMovieScene3DPathSection_Axis                      FrontAxisEnum;                                            // 0x00F8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EMovieScene3DPathSection_Axis                      UpAxisEnum;                                               // 0x00F9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFollow : 1;                                              // 0x00FA(0x0001) (Edit)
	unsigned char                                      bReverse : 1;                                             // 0x00FA(0x0001) (Edit)
	unsigned char                                      bForceUpright : 1;                                        // 0x00FA(0x0001) (Edit)
...
{
public:
	struct FMovieSceneTransformMask                    TransformMask;                                            // 0x0098(0x0004)
	struct FRichCurve                                  Translation[0x3];                                         // 0x009C(0x0054)
	struct FRichCurve                                  Rotation[0x3];                                            // 0x0198(0x0054)
	struct FRichCurve                                  Scale[0x3];                                               // 0x0294(0x0054)
	struct FRichCurve                                  ManualWeight;                                             // 0x0390(0x0054)
...
{
public:
	struct FName                                       PropertyName;                                             // 0x0050(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     PropertyPath;                                             // 0x0058(0x000C) (ZeroConstructor)
	TArray<class UMovieSceneSection*>                  Sections;                                                 // 0x0064(0x000C) (ExportObject, ZeroConstructor)
...
{
public:
	struct FIntegralCurve                              ActorGuidIndexCurve;                                      // 0x0098(0x0054)
	unsigned char                                      UnknownData00[0xC];                                       // 0x00EC(0x000C) MISSED OFFSET
	TArray<struct FString>                             ActorGuidStrings;                                         // 0x00F8(0x000C) (ZeroConstructor)
...
{
public:
	bool                                               DefaultValue;                                             // 0x0098(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	struct FIntegralCurve                              BoolCurve;                                                // 0x009C(0x0054)
...
{
public:
	struct FIntegralCurve                              ByteCurve;                                                // 0x0098(0x0054)
...
{
public:
	class UEnum*                                       Enum;                                                     // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UCameraAnim*                                 CameraAnim;                                               // 0x00AC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x00B0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              PlayScale;                                                // 0x00B4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              BlendInTime;                                              // 0x00B8(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              BlendOutTime;                                             // 0x00BC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bLooping;                                                 // 0x00C0(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	TArray<class UMovieSceneSection*>                  CameraAnimSections;                                       // 0x0050(0x000C) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x14];                                      // 0x0098(0x0014) MISSED OFFSET
	class UClass*                                      ShakeClass;                                               // 0x00AC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              PlayScale;                                                // 0x00B0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	TEnumAsByte<ECameraAnimPlaySpace>                  PlaySpace;                                                // 0x00B4(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00B5(0x0003) MISSED OFFSET
	struct FRotator                                    UserDefinedPlaySpace;                                     // 0x00B8(0x000C) (Deprecated, IsPlainOldData)
...
{
public:
	TArray<class UMovieSceneSection*>                  CameraShakeSections;                                      // 0x0050(0x000C) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
...
public:
	...
	class UMovieSceneSequence*                         SubSequence;                                              // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TLazyObjectPtr<class AActor>                       ActorToRecord;                                            // 0x00B8(0x001C) (Edit, IsPlainOldData)
	struct FString                                     TargetSequenceName;                                       // 0x00D4(0x000C) (Edit, ZeroConstructor)
	struct FDirectoryPath                              TargetPathToRecordTo;                                     // 0x00E0(0x000C) (Edit)
...
{
public:
	struct FRichCurve                                  RedCurve;                                                 // 0x0098(0x0054)
	struct FRichCurve                                  GreenCurve;                                               // 0x00EC(0x0054)
	struct FRichCurve                                  BlueCurve;                                                // 0x0140(0x0054)
	struct FRichCurve                                  AlphaCurve;                                               // 0x0194(0x0054)
...
{
public:
	bool                                               bIsSlateColor;                                            // 0x0070(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FIntegralCurve                              EnumCurve;                                                // 0x0098(0x0054)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00EC(0x0004) MISSED OFFSET
...
public:
	...
	struct FMovieSceneEventSectionData                 EventData;                                                // 0x00E0(0x0018)
	unsigned char                                      UnknownData01[0x60];                                      // 0x00F8(0x0060) MISSED OFFSET
...
{
public:
	TArray<struct FMovieSceneObjectBindingID>          EventReceivers;                                           // 0x0050(0x000C) (Edit, ZeroConstructor)
...
{
public:
	struct FRichCurve                                  FloatCurve;                                               // 0x0098(0x0054)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00EC(0x0004) MISSED OFFSET
...
public:
	...
	unsigned char                                      bFadeAudio : 1;                                           // 0x00FC(0x0001) (Edit)
...
{
public:
	struct FIntegralCurve                              IntegerCurve;                                             // 0x0098(0x0054)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00EC(0x0004) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0098(0x0008) MISSED OFFSET
	TArray<struct FVectorParameterNameAndCurves>       VectorParameterNamesAndCurves;                            // 0x00A0(0x000C) (ZeroConstructor)
	TArray<struct FColorParameterNameAndCurves>        ColorParameterNamesAndCurves;                             // 0x00AC(0x000C) (ZeroConstructor)
...
{
public:
	TArray<class UMovieSceneSection*>                  ParticleSections;                                         // 0x0050(0x000C) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
...
{
public:
	struct FMovieSceneSkeletalAnimationParams          Params;                                                   // 0x0098(0x0078) (Edit)
	class UAnimSequence*                               AnimSequence;                                             // 0x0110(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAnimSequenceBase*                           Animation;                                                // 0x0114(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              StartOffset;                                              // 0x0118(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              EndOffset;                                                // 0x011C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0120(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      bReverse : 1;                                             // 0x0124(0x0001) (Deprecated)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0125(0x0003) MISSED OFFSET
	struct FName                                       SlotName;                                                 // 0x0128(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	TArray<class UMovieSceneSection*>                  AnimationSections;                                        // 0x0050(0x000C) (ExportObject, ZeroConstructor)
	bool                                               bUseLegacySectionIndexBlend;                              // 0x005C(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	TArray<class UMovieSceneSection*>                  Sections;                                                 // 0x0050(0x000C) (ExportObject, ZeroConstructor)
	struct FGuid                                       ObjectGuid;                                               // 0x005C(0x0010) (IsPlainOldData)
...
{
public:
	struct FStringCurve                                StringCurve;                                              // 0x0098(0x0058)
...
{
public:
	struct FRichCurve                                  Curves[0x4];                                              // 0x0098(0x0054)
	int                                                ChannelsUsed;                                             // 0x01E8(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                NumChannelsUsed;                                          // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
