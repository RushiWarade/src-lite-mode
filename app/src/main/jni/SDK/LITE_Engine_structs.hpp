...
enum class EViewModeIndex : uint8_t
{
	...
	VMI_VertexCount                = 24,
	VMI_CPUInstancing              = 25,
	VMI_SoftOcclusion              = 26,
	VMI_Max                        = 27,
	VMI_Unknown                    = 28
};
...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData07[0x54];                                      // 0x00F4(0x0054) MISSED OFFSET
};
...
// ScriptStruct Engine.LODToSkipFrame
// 0x0008
struct FLODToSkipFrame
{
	int                                                SkipFrame;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	class UTexture2D*                                  DecalTexture;                                             // 0x0000(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) MISSED OFFSET
	class UObject*                                     Mesh;                                                     // 0x0004(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0008(0x0004) MISSED OFFSET
	TArray<struct FDecalParameter>                     DecalParams;                                              // 0x000C(0x000C) (ZeroConstructor, Transient)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0018(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FPredictProjectilePathParams
{
	...
	float                                              GravityScale;                                             // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              IgnoreGravityDis;                                         // 0x004C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Engine.CullingSizeLimitItem
// 0x0014
struct FCullingSizeLimitItem
{
	struct FString                                     LODGroup;                                                 // 0x0000(0x000C) (ZeroConstructor)
	float                                              MinCullingSize;                                           // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MaxCullingSize;                                           // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Engine.CullingSizeLimitInMaps
// 0x0018
struct FCullingSizeLimitInMaps
{
	struct FString                                     MapName;                                                  // 0x0000(0x000C) (ZeroConstructor)
	TArray<struct FCullingSizeLimitItem>               Limits;                                                   // 0x000C(0x000C) (ZeroConstructor)
};
...
struct FReplicatedStaticActorDestructionInfo
{
	...
	class UClass*                                      ObjClass;                                                 // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FObjectPool
{
	...
	TMap<class UObject*, uint32_t>                     RecycleTime;                                              // 0x0010(0x003C) (ZeroConstructor, Transient)
	int                                                Size;                                                     // 0x004C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoDestroy;                                             // 0x0050(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FObjectPoolManager
{
	...
	bool                                               bEnabledAutoDestroy;                                      // 0x0001(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0002(0x0002) MISSED OFFSET
	TMap<class UClass*, struct FObjectPool>            Pools;                                                    // 0x0004(0x003C) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x3C];                                      // 0x0040(0x003C) UNKNOWN PROPERTY: SetProperty Engine.ObjectPoolManager.EnabledClasses
};
...
struct FPoseDataContainer
{
	...
	TMap<struct FName, int>                            TrackMap;                                                 // 0x0024(0x003C) (ZeroConstructor, Transient)
...
struct FTimeline
{
	...
	class UProperty*                                   DirectionProperty;                                        // 0x0080(0x0004) (ZeroConstructor, Transient, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) MISSED OFFSET
	class UClass*                                      DamageTypeClass;                                          // 0x0004(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
};
...
struct FUserDetailSetting
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	int                                                UserShadowSetting;                                        // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                UserShadowSwitch;                                         // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGLimitSetting;                                         // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceUpdateFlag;                                     // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSLow;                                         // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSMid;                                         // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSHigh;                                        // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSHDR;                                         // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PUBGCRLRuntmieMinMem;                                     // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGRenderSwitch;                                         // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsSupportTagCulling;                                      // 0x004C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x004D(0x0003) MISSED OFFSET
	int                                                UserMaterialQualityLevel;                                 // 0x0050(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAnimMontageInstance
{
	...
	bool                                               bPlaying;                                                 // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	float                                              DefaultBlendTimeMultiplier;                               // 0x0018(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x94];                                      // 0x001C(0x0094) MISSED OFFSET
	TArray<int>                                        NextSections;                                             // 0x00B0(0x000C) (ZeroConstructor)
	TArray<int>                                        PrevSections;                                             // 0x00BC(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0xC];                                       // 0x00C8(0x000C) MISSED OFFSET
	TArray<struct FAnimNotifyEvent>                    ActiveStateBranchingPoints;                               // 0x00D4(0x000C) (ZeroConstructor, Transient)
	float                                              Position;                                                 // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x00E4(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAlphaBlend                                 Blend;                                                    // 0x00E8(0x002C) (Transient)
	unsigned char                                      UnknownData04[0x20];                                      // 0x0114(0x0020) MISSED OFFSET
	int                                                DisableRootMotionCount;                                   // 0x0134(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x14];                                      // 0x0138(0x0014) MISSED OFFSET
};
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData00[0xD];                                       // 0x002B(0x000D) MISSED OFFSET
};
...
// ScriptStruct Engine.DummyStruct
// 0x0001
struct FDummyStruct
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) MISSED OFFSET
...
struct FAnimUpdateRateParameters
{
	...
	int                                                CurrentAnimFrame;                                         // 0x001C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	int                                                SkipAnimFrameCount;                                       // 0x0020(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	int                                                BaseNonRenderedUpdateRate;                                // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BaseNonRenderedShouldUpdateRate;                          // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MinDistFromMainChar;                                      // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxDistFromMainChar;                                      // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseSkipMapForDistanceFactor : 1;                         // 0x0034(0x0001)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0035(0x0003) MISSED OFFSET
	TArray<float>                                      BaseVisibleDistanceFactorThesholds;                       // 0x0038(0x000C) (ZeroConstructor)
	TArray<struct FLODToSkipFrame>                     LODToFrameSkipMap;                                        // 0x0044(0x000C) (ZeroConstructor)
	int                                                MaxEvalRateForInterpolation;                              // 0x0050(0x0004) (ZeroConstructor, IsPlainOldData)
	EUpdateRateShiftBucket                             ShiftBucket;                                              // 0x0054(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FMeshMergingSettings
{
	...
	float                                              MaxMergeXRange;                                           // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxMergeYRange;                                           // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x00D0(0x0004) MISSED OFFSET
};
...
struct FWorldRegionManager
{
	...
	TMap<struct FRegionID, struct FRegionObjectItemList> RegionIDToObjectList_Static;                              // 0x0080(0x003C) (ZeroConstructor, Transient)
	TMap<struct FRegionID, struct FRegionObjectItemList> RegionIDToObjectList_NonStatic;                           // 0x00BC(0x003C) (ZeroConstructor, Transient)
	TMap<class UObject*, struct FRegionID>             ObjectToRegionID_NonStatic;                               // 0x00F8(0x003C) (ZeroConstructor, Transient)
...
{
	TMap<uint32_t, struct FMeshSectionInfo>            Map;                                                      // 0x0000(0x003C) (ZeroConstructor)
};
...
struct FHierarchicalSimplification
{
	...
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x00D0(0x00D4) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x01A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x01A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x01AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
