...
public:
	...
	TMap<int, bool>                                    HasSeeShopItemDict;                                       // 0x0094(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TMap<struct FString, int>                          UidClickTimeNotBind;                                      // 0x00E8(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, int>                          UidClickTimeBind;                                         // 0x0124(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TMap<struct FString, struct FString>               ConfigStringMap;                                          // 0x0174(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, int>                          ConfigIntMap;                                             // 0x01B0(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, float>                        ConfigFloatMap;                                           // 0x01EC(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, bool>                         ConfigBoolMap;                                            // 0x0228(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, int>                          UidAirDropTime;                                           // 0x0264(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TMap<struct FString, bool>                         HasClickUPassAct;                                         // 0x02C0(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, bool>                         HasClickInviteTeamAct;                                    // 0x02FC(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int                                                CursorFaceInfoID;                                         // 0x0338(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TMap<struct FString, struct FString>               FaceInfoClickedIDAndTime;                                 // 0x033C(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TMap<struct FString, int>                          ClickTimeHalloweenVehicle;                                // 0x037C(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, bool>                         HasClickHalloweenExchange;                                // 0x03B8(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TMap<struct FString, int>                          ClickTimeIceLucky;                                        // 0x0404(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TMap<struct FString, bool>                         HasCliickVehicleAcitivtyGuide;                            // 0x0444(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, int>                          ClickTimeAnniversary;                                     // 0x0480(0x003C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
