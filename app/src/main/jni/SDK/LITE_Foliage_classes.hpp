...
{
public:
	struct FScriptMulticastDelegate                    OnInstanceTakePointDamage;                                // 0x0720(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x072C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TEnumAsByte<EFoliageVertexColorMask>               VertexColorMask;                                          // 0x0084(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	TEnumAsByte<EComponentMobility>                    Mobility;                                                 // 0x010C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bUseAsOccluder : 1;                                       // 0x0120(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData10[0x7];                                       // 0x0121(0x0007) MISSED OFFSET
	struct FBodyInstance                               BodyInstance;                                             // 0x0128(0x0148) (Edit)
	TEnumAsByte<EHasCustomNavigableGeometry>           CustomNavigableGeometry;                                  // 0x0270(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLightingChannels                           LightingChannels;                                         // 0x0271(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x0272(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData11[0x1];                                       // 0x0273(0x0001) MISSED OFFSET
	int                                                CustomDepthStencilValue;                                  // 0x0274(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData12[0x2];                                       // 0x029E(0x0002) MISSED OFFSET
	...
	struct FFloatInterval                              ProceduralScale;                                          // 0x02AC(0x0008) (Edit)
	struct FRuntimeFloatCurve                          ScaleCurve;                                               // 0x02B4(0x0058) (Edit)
	int                                                ChangeCount;                                              // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      ReapplyDensity : 1;                                       // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyRadius : 1;                                        // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyAlignToNormal : 1;                                 // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyRandomYaw : 1;                                     // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaling : 1;                                       // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaleX : 1;                                        // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaleY : 1;                                        // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaleZ : 1;                                        // 0x0310(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyRandomPitchAngle : 1;                              // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyGroundSlope : 1;                                   // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyHeight : 1;                                        // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyLandscapeLayers : 1;                               // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyZOffset : 1;                                       // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyCollisionWithWorld : 1;                            // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyVertexColorMask : 1;                               // 0x0311(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bEnableDensityScaling : 1;                                // 0x0311(0x0001) (Edit)
	unsigned char                                      UnknownData13[0x6];                                       // 0x0312(0x0006) MISSED OFFSET
...
{
public:
	bool                                               bShouldAttachToBaseComponent;                             // 0x0318(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                        // 0x0318(0x000C) (Edit, ZeroConstructor)
	class UClass*                                      ComponentClass;                                           // 0x0324(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           CapsuleComponent;                                         // 0x02D0(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FVector                                     TouchingActorEntryPosition;                               // 0x02D4(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x02E0(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x02EC(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x02F8(0x000C) (Transient, IsPlainOldData)
	float                                              FoliageDamageImpulseScale;                                // 0x0304(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageTouchImpulseScale;                                 // 0x0308(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageStiffness;                                         // 0x030C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageStiffnessQuadratic;                                // 0x0310(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageDamping;                                           // 0x0314(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxDamageImpulse;                                         // 0x0318(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxTouchImpulse;                                          // 0x031C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxForce;                                                 // 0x0320(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Mass;                                                     // 0x0324(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AProceduralFoliageVolume*                    ProceduralFoliageVolume;                                  // 0x02F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class AVolume*                                     SpawningVolume;                                           // 0x00C4(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ProceduralGuid;                                           // 0x00C8(0x0010) (IsPlainOldData)
...
{
public:
	class UProceduralFoliageComponent*                 ProceduralComponent;                                      // 0x02F0(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x02F4(0x0004) MISSED OFFSET
