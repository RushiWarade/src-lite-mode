...
{
public:
	int                                                PlayerIndex;                                              // 0x0500(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EControllerHand                                    Hand;                                                     // 0x0504(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDisableLowLatencyUpdate : 1;                             // 0x0505(0x0001) (Edit, BlueprintVisible)
	ETrackingStatus                                    CurrentTrackingStatus;                                    // 0x0506(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x59];                                      // 0x0507(0x0059) MISSED OFFSET
