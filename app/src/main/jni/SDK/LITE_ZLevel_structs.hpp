...
{
	struct FString                                     Desc;                                                     // 0x0000(0x000C) (Edit, ZeroConstructor)
	TEnumAsByte<EGenerateType>                         ChooseGroupSpotType;                                      // 0x000C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
...
struct FMonsterWave
{
	...
	TEnumAsByte<EMonsterWaveEndCondType>               EndCondType;                                              // 0x001C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FLevelData
{
	...
	TEnumAsByte<ELevelEndCondType>                     EndCondType;                                              // 0x002C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
