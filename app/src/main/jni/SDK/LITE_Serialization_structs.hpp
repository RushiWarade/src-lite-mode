...
{
	TMap<int, struct FString>                          IntToStr;                                                 // 0x0000(0x003C) (ZeroConstructor)
	TMap<struct FString, struct FString>               StrToStr;                                                 // 0x003C(0x003C) (ZeroConstructor)
	TMap<struct FString, struct FVector>               StrToVec;                                                 // 0x0078(0x003C) (ZeroConstructor)
};
