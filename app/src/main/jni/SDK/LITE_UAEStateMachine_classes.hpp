...
public:
	...
	TMap<struct FString, struct FUAEStateMachineTransition> Transitions;                                              // 0x00EC(0x003C) (Edit, ZeroConstructor, DisableEditOnInstance)
...
{
public:
	class UUAEStateMachineComponent*                   UAEStateMachineComponent;                                 // 0x02C8(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
