...
struct UPanelWidget_DoToAllChildren_Params
{
...
struct UImage_SetBrushFromPath_Params
{
...
struct UInvalidationBox_SetMinKeepCacheTime_Params
{
...
struct UInvalidationBox_GetMinKeepCacheTime_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
