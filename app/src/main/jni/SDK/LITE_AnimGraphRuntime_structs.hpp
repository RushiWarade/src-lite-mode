...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     OldLocalJointOffset;                                      // 0x00C8(0x000C) (IsPlainOldData)
	float                                              GravityScale;                                             // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLinearSpring;                                            // 0x00D8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAngularSpring;                                           // 0x00D9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x00DA(0x0002) MISSED OFFSET
	float                                              LinearSpringConstant;                                     // 0x00DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AngularSpringConstant;                                    // 0x00E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableWind;                                              // 0x00E4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindWasEnabled;                                          // 0x00E5(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x00E6(0x0002) MISSED OFFSET
	float                                              WindScale;                                                // 0x00E8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideLinearDamping;                                   // 0x00EC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x00ED(0x0003) MISSED OFFSET
	float                                              LinearDampingOverride;                                    // 0x00F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularDamping;                                  // 0x00F4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x00F5(0x0003) MISSED OFFSET
	float                                              AngularDampingOverride;                                   // 0x00F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularBias;                                     // 0x00FC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x00FD(0x0003) MISSED OFFSET
	float                                              AngularBiasOverride;                                      // 0x0100(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDoUpdate;                                                // 0x0104(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x0105(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x0106(0x0002) MISSED OFFSET
	int                                                NumSolverIterationsPreUpdate;                             // 0x0108(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumSolverIterationsPostUpdate;                            // 0x010C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FAnimPhysConstraintSetup                    ConstraintSetup;                                          // 0x0110(0x005C) (Edit)
	bool                                               bUseDynamicAngularLimits;                                 // 0x016C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x016D(0x0003) MISSED OFFSET
	struct FVector                                     Dynamic_AngularLimitsMin;                                 // 0x0170(0x000C) (Edit, BlueprintVisible, Transient, IsPlainOldData)
	struct FVector                                     Dynamic_AngularLimitsMax;                                 // 0x017C(0x000C) (Edit, BlueprintVisible, Transient, IsPlainOldData)
	bool                                               bUsePlanarLimit;                                          // 0x0188(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0189(0x0003) MISSED OFFSET
	TArray<struct FAnimPhysPlanarLimit>                PlanarLimits;                                             // 0x018C(0x000C) (Edit, ZeroConstructor)
	bool                                               bUseSphericalLimits;                                      // 0x0198(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0199(0x0003) MISSED OFFSET
	TArray<struct FAnimPhysSphericalLimit>             SphericalLimits;                                          // 0x019C(0x000C) (Edit, ZeroConstructor)
	EAnimPhysCollisionType                             CollisionType;                                            // 0x01A8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x01A9(0x0003) MISSED OFFSET
	float                                              SphereCollisionRadius;                                    // 0x01AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NonEvaluateFrameNum;                                      // 0x01B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	struct FVector                                     ExternalForce;                                            // 0x01B8(0x000C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData13[0xA4];                                      // 0x01C4(0x00A4) MISSED OFFSET
};
