...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x0100(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0104(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x010C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x140];                                     // 0x0110(0x0140) MISSED OFFSET
...
{
public:
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x0250(0x000C) (IsPlainOldData)
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x025C(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0260(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x0264(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0268(0x0004) (Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x24];                                      // 0x026C(0x0024) MISSED OFFSET
...
public:
	...
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x060A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EPawnActionFailHandling>               ChildFailureHandlingMode;                                 // 0x006C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EPawnActionFailHandling>               ChildFailureHandlingMode;                                 // 0x0070(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
