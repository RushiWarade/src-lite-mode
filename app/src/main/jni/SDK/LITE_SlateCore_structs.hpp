...
struct FSlateBrush
{
	...
	bool                                               bOnlySoftInEditor;                                        // 0x0038(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<ESlateBrushDrawType>                   DrawAs;                                                   // 0x0084(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ESlateBrushTileType>                   Tiling;                                                   // 0x0085(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ESlateBrushMirrorType>                 Mirroring;                                                // 0x0086(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ESlateBrushImageType>                  ImageType;                                                // 0x0087(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FTableRowStyle : public FSlateWidgetStyle
{
	...
	struct FSlateColor                                 TextColor;                                                // 0x0518(0x001C) (Edit, BlueprintVisible)
	struct FSlateColor                                 SelectedTextColor;                                        // 0x0534(0x001C) (Edit, BlueprintVisible)
	struct FSlateBrush                                 DropIndicator_Above;                                      // 0x0550(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 DropIndicator_Onto;                                       // 0x05E0(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 DropIndicator_Below;                                      // 0x0670(0x0090) (Edit, BlueprintVisible)
};
...
// 0x03CC (0x03D0 - 0x0004)
struct FComboButtonStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FButtonStyle                                ButtonStyle;                                              // 0x0008(0x0298) (Edit, BlueprintVisible)
	struct FSlateBrush                                 DownArrowImage;                                           // 0x02A0(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 MenuBorderBrush;                                          // 0x0330(0x0090) (Edit, BlueprintVisible)
	struct FMargin                                     MenuBorderPadding;                                        // 0x03C0(0x0010) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.ComboBoxStyle
// 0x0404 (0x0408 - 0x0004)
struct FComboBoxStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FComboButtonStyle                           ComboButtonStyle;                                         // 0x0008(0x03D0) (Edit, BlueprintVisible)
	struct FSlateSound                                 PressedSlateSound;                                        // 0x03D8(0x0018) (Edit, BlueprintVisible)
	struct FSlateSound                                 SelectionChangeSlateSound;                                // 0x03F0(0x0018) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.EditableTextStyle
// 0x0214 (0x0218 - 0x0004)
struct FEditableTextStyle : public FSlateWidgetStyle
{
	...
	struct FSlateBrush                                 BackgroundImageSelected;                                  // 0x0068(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BackgroundImageComposing;                                 // 0x00F8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 CaretImage;                                               // 0x0188(0x0090) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.ScrollBarStyle
// 0x0514 (0x0518 - 0x0004)
...
struct FEditableTextBoxStyle : public FSlateWidgetStyle
{
	...
	struct FSlateColor                                 ForegroundColor;                                          // 0x0298(0x001C) (Edit, BlueprintVisible)
	struct FSlateColor                                 BackgroundColor;                                          // 0x02B4(0x001C) (Edit, BlueprintVisible)
	struct FSlateColor                                 ReadOnlyForegroundColor;                                  // 0x02D0(0x001C) (Edit, BlueprintVisible)
	struct FMargin                                     HScrollBarPadding;                                        // 0x02EC(0x0010) (Edit, BlueprintVisible)
	struct FMargin                                     VScrollBarPadding;                                        // 0x02FC(0x0010) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x4];                                       // 0x030C(0x0004) MISSED OFFSET
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x0310(0x0518) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.TextBlockStyle
// 0x01C4 (0x01C8 - 0x0004)
struct FTextBlockStyle : public FSlateWidgetStyle
{
	...
	struct FSlateBrush                                 HighlightShape;                                           // 0x00A8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 UnderlineBrush;                                           // 0x0138(0x0090) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.SpinBoxStyle
// 0x0304 (0x0308 - 0x0004)
struct FSpinBoxStyle : public FSlateWidgetStyle
{
	...
	struct FSlateColor                                 ForegroundColor;                                          // 0x02D8(0x001C)
	struct FMargin                                     TextPadding;                                              // 0x02F4(0x0010) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0304(0x0004) MISSED OFFSET
};

// ScriptStruct SlateCore.ScrollBoxStyle
// 0x0244 (0x0248 - 0x0004)
...
// 0x105C (0x1060 - 0x0004)
struct FWindowStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FButtonStyle                                MinimizeButtonStyle;                                      // 0x0008(0x0298) (Edit, BlueprintVisible)
	struct FButtonStyle                                MaximizeButtonStyle;                                      // 0x02A0(0x0298) (Edit, BlueprintVisible)
	struct FButtonStyle                                RestoreButtonStyle;                                       // 0x0538(0x0298) (Edit, BlueprintVisible)
	struct FButtonStyle                                CloseButtonStyle;                                         // 0x07D0(0x0298) (Edit, BlueprintVisible)
	struct FTextBlockStyle                             TitleTextStyle;                                           // 0x0A68(0x01C8) (Edit, BlueprintVisible)
	struct FSlateBrush                                 ActiveTitleBrush;                                         // 0x0C30(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 InactiveTitleBrush;                                       // 0x0CC0(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 FlashTitleBrush;                                          // 0x0D50(0x0090) (Edit, BlueprintVisible)
	struct FSlateColor                                 BackgroundColor;                                          // 0x0DE0(0x001C) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0DFC(0x0004) MISSED OFFSET
	struct FSlateBrush                                 OutlineBrush;                                             // 0x0E00(0x0090) (Edit, BlueprintVisible)
	struct FSlateColor                                 OutlineColor;                                             // 0x0E90(0x001C) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0EAC(0x0004) MISSED OFFSET
	struct FSlateBrush                                 BorderBrush;                                              // 0x0EB0(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BackgroundBrush;                                          // 0x0F40(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 ChildBackgroundBrush;                                     // 0x0FD0(0x0090) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.ScrollBorderStyle
// 0x0124 (0x0128 - 0x0004)
...
// 0x074C (0x0750 - 0x0004)
struct FDockTabStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FButtonStyle                                CloseButtonStyle;                                         // 0x0008(0x0298) (Edit)
	struct FSlateBrush                                 NormalBrush;                                              // 0x02A0(0x0090) (Edit)
	struct FSlateBrush                                 ActiveBrush;                                              // 0x0330(0x0090) (Edit)
	struct FSlateBrush                                 ColorOverlayTabBrush;                                     // 0x03C0(0x0090) (Edit)
	struct FSlateBrush                                 ColorOverlayIconBrush;                                    // 0x0450(0x0090) (Edit)
	struct FSlateBrush                                 ForegroundBrush;                                          // 0x04E0(0x0090) (Edit)
	struct FSlateBrush                                 HoveredBrush;                                             // 0x0570(0x0090) (Edit)
	struct FSlateBrush                                 ContentAreaBrush;                                         // 0x0600(0x0090) (Edit)
	struct FSlateBrush                                 TabWellBrush;                                             // 0x0690(0x0090) (Edit)
	struct FMargin                                     TabPadding;                                               // 0x0720(0x0010) (Edit)
	float                                              OverlapWidth;                                             // 0x0730(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FSlateColor                                 FlashColor;                                               // 0x0734(0x001C) (Edit)
};
...
struct FHeaderRowStyle : public FSlateWidgetStyle
{
	...
	struct FSlateColor                                 ForegroundColor;                                          // 0x0BF0(0x001C) (Edit)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0C0C(0x0004) MISSED OFFSET
};

// ScriptStruct SlateCore.InlineTextImageStyle
// 0x009C (0x00A0 - 0x0004)
...
// 0x0AC4 (0x0AC8 - 0x0004)
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FEditableTextBoxStyle                       TextBoxStyle;                                             // 0x0008(0x0828) (Edit)
	struct FSlateFontInfo                              ActiveFontInfo;                                           // 0x0830(0x0040) (Edit)
	struct FSlateBrush                                 UpArrowImage;                                             // 0x0870(0x0090) (Edit)
	struct FSlateBrush                                 DownArrowImage;                                           // 0x0900(0x0090) (Edit)
	struct FSlateBrush                                 GlassImage;                                               // 0x0990(0x0090) (Edit)
	struct FSlateBrush                                 ClearImage;                                               // 0x0A20(0x0090) (Edit)
	struct FMargin                                     ImagePadding;                                             // 0x0AB0(0x0010) (Edit)
	bool                                               bLeftAlignButtons;                                        // 0x0AC0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0AC1(0x0007) MISSED OFFSET
};
...
// 0x09F4 (0x09F8 - 0x0004)
struct FInlineEditableTextBlockStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FEditableTextBoxStyle                       EditableTextBoxStyle;                                     // 0x0008(0x0828) (Edit, BlueprintVisible)
	struct FTextBlockStyle                             TextStyle;                                                // 0x0830(0x01C8) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.HyperlinkStyle
// 0x0474 (0x0478 - 0x0004)
struct FHyperlinkStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FButtonStyle                                UnderlineStyle;                                           // 0x0008(0x0298) (Edit, BlueprintVisible)
	struct FTextBlockStyle                             TextStyle;                                                // 0x02A0(0x01C8) (Edit, BlueprintVisible)
	struct FMargin                                     Padding;                                                  // 0x0468(0x0010) (Edit, BlueprintVisible)
};

// ScriptStruct SlateCore.CheckBoxStyle
// 0x05A4 (0x05A8 - 0x0004)
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	struct FSlateBrush                                 UncheckedImage;                                           // 0x0008(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 UncheckedHoveredImage;                                    // 0x0098(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 UncheckedPressedImage;                                    // 0x0128(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 CheckedImage;                                             // 0x01B8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 CheckedHoveredImage;                                      // 0x0248(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 CheckedPressedImage;                                      // 0x02D8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 UndeterminedImage;                                        // 0x0368(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 UndeterminedHoveredImage;                                 // 0x03F8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 UndeterminedPressedImage;                                 // 0x0488(0x0090) (Edit, BlueprintVisible)
	struct FMargin                                     Padding;                                                  // 0x0518(0x0010) (Edit, BlueprintVisible)
	struct FSlateColor                                 ForegroundColor;                                          // 0x0528(0x001C) (Edit, BlueprintVisible)
	struct FSlateColor                                 BorderBackgroundColor;                                    // 0x0544(0x001C) (Edit, BlueprintVisible)
	struct FSlateSound                                 CheckedSlateSound;                                        // 0x0560(0x0018) (Edit, BlueprintVisible)
	struct FSlateSound                                 UncheckedSlateSound;                                      // 0x0578(0x0018) (Edit, BlueprintVisible)
	struct FSlateSound                                 HoveredSlateSound;                                        // 0x0590(0x0018) (Edit, BlueprintVisible)
};
