...
public:
	...
	unsigned char                                      UnknownData03[0x24];                                      // 0x00B8(0x0024) MISSED OFFSET
	struct FGuid                                       PlayerGuid;                                               // 0x00DC(0x0010) (IsPlainOldData)
...
{
public:
	struct FLinearColor                                ClearColor;                                               // 0x0098(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UMediaPlayer*                                MediaPlayer;                                              // 0x00A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
