...
struct FUTSkillCreateData
{
	...
	int                                                CoolDownMessageID;                                        // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Range;                                                    // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UUTSkillPhase*>                       Phases;                                                   // 0x0020(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	bool                                               bIgnoreDamage;                                            // 0x002C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Skill.UTAddedSkillSturct
// 0x0038
struct FUTAddedSkillSturct
{
	unsigned char                                      UnknownData00[0x28];                                      // 0x0000(0x0028) UNKNOWN PROPERTY: SoftClassProperty Skill.UTAddedSkillSturct.SkillTemplate
	struct FString                                     SkillTemplatePath;                                        // 0x0028(0x000C) (Edit, BlueprintVisible, ZeroConstructor, EditConst)
	int                                                SkillIndex;                                               // 0x0034(0x0004) (Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData)
};
...
struct FUTSkillPhaseCreateData
{
	...
	TArray<class UUTSkillCondition*>                   PhaseConditions;                                          // 0x001C(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
	class UUTSkillPicker*                              Picker;                                                   // 0x0028(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	TArray<class UUTSkillEffect*>                      Actions;                                                  // 0x002C(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance)
	TArray<class UUTSkillEffect*>                      HurtAppearances;                                          // 0x0038(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance)
	EUTSkillPhaseType                                  PhaseType;                                                // 0x0044(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0045(0x0003) MISSED OFFSET
	struct FString                                     EnterPhaseTipString;                                      // 0x0048(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x0054(0x000C) (ExportObject, ZeroConstructor)
};
