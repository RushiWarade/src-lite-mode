...
void Abp_global_C::EventShowLoadAdvertiseError_NoFetch()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function bp_global.bp_global_C.EventShowLoadAdvertiseError_NoFetch");

	Abp_global_C_EventShowLoadAdvertiseError_NoFetch_Params params;
...
void Abp_global_C::EventShowLoadAdvertiseError()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc = UObject::FindObject<UFunction>("Function bp_global.bp_global_C.EventShowLoadAdvertiseError");

	Abp_global_C_EventShowLoadAdvertiseError_Params params;
