...
struct FItem_TabRes
{
	...
	struct FString                                     ArmorySimpleDesc;                                         // 0x013C(0x000C) (ZeroConstructor)
	struct FString                                     ArmoryDesc;                                               // 0x0148(0x000C) (ZeroConstructor)
	struct FString                                     ItemSmallIcon2;                                           // 0x0154(0x000C) (ZeroConstructor)
	struct FString                                     ItemBigIcon2;                                             // 0x0160(0x000C) (ZeroConstructor)
	struct FString                                     BackpackSimple;                                           // 0x016C(0x000C) (ZeroConstructor)
	int                                                UseType;                                                  // 0x0178(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                gender;                                                   // 0x017C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ArmoryJumpId;                                             // 0x0180(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CharmValue;                                               // 0x0184(0x0004) (ZeroConstructor, IsPlainOldData)
};
