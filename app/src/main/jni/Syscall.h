...
typedef char PACKAGENAME;  // Define PACKAGENAME as char
typedef unsigned short UTF16;
typedef unsigned char UTF8;  // Define UTF8 as unsigned char
...
void getUTF8(char * buf, long namepy)
{
    ...
    UTF8 *pTempUTF8 = reinterpret_cast<UTF8 *>(buf);
